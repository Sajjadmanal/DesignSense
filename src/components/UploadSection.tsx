...
export function UploadSection({ onFileUpload, onAnalysisStart }: UploadSectionProps) {
  ...
  return (
    <div className="min-h-screen pt-24 px-6">
      <div className="max-w-6xl mx-auto mx-[0px] my-[24px]">
        {/* Header */}
        <motion.div 
        ...
        >
          <Badge className="bg-[#00ED64]/20 text-[#00ED64] border-[#00ED64]/30 mb-6">
            🚀 AI-Powered Design Analysis
          </Badge>
          <h1 className="text-5xl font-bold text-[#00ED64] mb-4">
        ...
        >
          ...
          <div className="lg:col-span-2">
            <Card 
              className={`bg-[#012A3A] border-2 border-dashed transition-all duration-300 ${
                isDragging 
                  ? 'border-[#00ED64] bg-[#00ED64]/10' 
                  : 'border-[#013D52] hover:border-[#00ED64]/50'
              }`}
            ...
            >
              <div className="p-12 text-center">
                <motion.div
                  ...
                  className="w-20 h-20 mx-auto mb-6 bg-[#00ED64] rounded-2xl flex items-center justify-center"
                >
                  <Upload className="w-10 h-10 text-[#001E2B]" />
                </motion.div>
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-[#012A3A] border border-[#013D52] p-6">
              ...
              <Button 
                variant="outline" 
                className="w-full border-[#013D52] text-white hover:bg-white/10"
              >
              ...
              <div className="space-y-3">
                {[
                  ...
                  <motion.div
                    ...
                    className="flex items-center justify-between p-3 rounded-lg bg-[#013D52] hover:bg-[#013D52]/70 transition-colors cursor-pointer"
                  >
                    <div className="flex items-center gap-3">
                      <FileImage className="w-4 h-4 text-[#00ED64]" />
                      <div>
                    ...
                    <Badge 
                      variant="secondary" 
                      className={`${
                        file.score >= 90 ? 'bg-[#00ED64]/20 text-[#00ED64]' :
        ...
        >
          {[
            ...
            <motion.div
              ...
              whileHover={{ y: -5 }}
            >
              <Card className="bg-[#012A3A] border border-[#013D52] p-6 h-full hover:bg-[#013D52] transition-all duration-300">
                <div className={`w-12 h-12 ${feature.color} rounded-xl flex items-center justify-center mb-4`}>
                  <feature.icon className="w-6 h-6 text-[#001E2B]" />
                </div>
