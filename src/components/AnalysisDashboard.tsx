...
export function AnalysisDashboard({ uploadedFile }: AnalysisDashboardProps) {
  ...
  const getScoreColor = (score: number) => {
    if (score >= 90) return 'text-[#00ED64]';
    ...
    return (
      <div className="min-h-screen pt-24 px-6 flex items-center justify-center">
        <div className="text-center">
          <div className="w-24 h-24 mx-auto mb-6 bg-[#013D52] rounded-2xl flex items-center justify-center">
    ...
    <div className="min-h-screen pt-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="flex gap-3">
            <Button 
              ...
              className="border-[#013D52] text-white hover:bg-white/10"
            >
            ...
            <Button 
              ...
              className="bg-[#00ED64] hover:bg-[#00ED64]/90 text-[#001E2B] border-0"
            >
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <Card className="bg-[#012A3A] border border-[#013D52] p-8">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                {isAnalyzing && (
                  <div className="mt-2">
                    <div className="animate-pulse text-[#00ED64] text-sm">Analyzing...</div>
                  </div>
                )}
              </div>
            </div>
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <Card className="bg-[#012A3A] border border-[#013D52] p-6">
            <h3 className="text-xl font-semibold text-white mb-4">Design Preview with Issues</h3>
            <div className="relative bg-[#001E2B] rounded-lg p-8 min-h-[400px] overflow-hidden">
              {/* Mock design preview */}
              <div className="absolute inset-4 bg-white rounded-lg shadow-lg">
                <div className="p-6">
                  ...
                  <div className="h-10 bg-[#00ED64] rounded mb-4"></div>
                </div>
              </div>
                ...
                >
                  ...
                  {selectedIssue === issue.id && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, scale: 1 }}
                      className="absolute top-8 left-0 w-64 p-3 bg-[#001E2B]/90 backdrop-blur-xl rounded-lg border border-[#013D52] z-20"
                    >
                      ...
                      <p className="text-[#00ED64] text-xs">{issue.suggestion}</p>
                    </motion.div>
                  )}
                </motion.div>
              ))}
        ...
        >
          {Object.entries(analysisData.categories).map(([category, data], index) => {
            ...
            return (
              ...
              >
                <Card className="bg-[#012A3A] border border-[#013D52] p-6 hover:bg-[#013D52] transition-all">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#00ED64] rounded-lg flex items-center justify-center">
                        <Icon className="w-5 h-5 text-[#001E2B]" />
                      </div>
                      <div>
        ...
        >
          <Card className="bg-[#012A3A] border border-[#013D52]">
            <Tabs defaultValue="all" className="w-full">
              <div className="p-6 border-b border-[#013D52]">
                <h3 className="text-xl font-semibold text-white mb-4">Issues & Suggestions</h3>
                <TabsList className="bg-[#013D52] border border-[#013D52]">
                  <TabsTrigger value="all" className="data-[state=active]:bg-[#00ED64] data-[state=active]:text-[#001E2B]">All Issues</TabsTrigger>
                  ...
                  <div className="space-y-4">
                    {analysisData.issues.map((issue, index) => (
                      <motion.div
                        ...
                        className="p-4 rounded-lg bg-[#013D52] border border-[#013D52] hover:bg-[#013D52]/70 transition-all cursor-pointer"
                      ...
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="p-3 bg-[#00ED64]/10 border border-[#00ED64]/30 rounded-lg">
                ...
                <ScrollArea className="h-96">
                  <div className="space-y-4">
                    {analysisData.issues
                      ...
                      .map((issue, index) => (
                        <div key={issue.id} className="p-4 rounded-lg bg-[#013D52] border border-[#013D52]">
                          <div className="flex items-center gap-3 mb-2">
                            <Badge className={getSeverityColor(issue.severity)}>
                              {issue.severity}
                            </Badge>
        ...
        <motion.div
          ...
          className="mt-8"
        >
          <Card className="bg-[#012A3A] border border-[#013D52] mx-[0px] my-[24px]">
            <div className="p-6 border-b border-[#013D52]">
              <div className="flex items-center justify-between">
                <div>
            ...
            <div className="p-6 mx-[0px] my-[24px]">
              {/* Design Systems Grid */}
                    ...
                    <Card 
                      className={`cursor-pointer transition-all duration-300 border-2 ${
                        selectedDesignSystem === system.name
                          ...
                          : 'border-[#013D52] bg-[#013D52] hover:border-[#00ED64]/50 hover:bg-[#013D52]/70'
                      }`}
                        ...
                        <div className="space-y-1">
                          {system.features.map((feature, idx) => (
                            <div key={idx} className="flex items-center gap-2">
                              <div className="w-1 h-1 bg-[#00ED64] rounded-full"></div>
              ...
              {showPreview && selectedDesignSystem && (
                <motion.div
                  ...
                  className="mt-8"
                >
                  <Card className="bg-[#013D52] border border-[#013D52] p-6">
                    <div className="flex items-center gap-3 mb-6">
                      <ArrowLeftRight className="w-5 h-5 text-[#00ED64]" />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <div className="relative bg-[#001E2B] rounded-lg p-4 min-h-[300px]">
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-4">
                          <Badge className="bg-[#00ED64]/20 text-[#00ED64] border-[#00ED64]/30">After</Badge>
                          ...
                          <div className="absolute inset-2 bg-white rounded-lg shadow-lg overflow-hidden">
                            <div className="p-4">
                              ...
                              {(selectedDesignSystem === 'Ant Design' || selectedDesignSystem === 'Chakra UI') && (
                                <>
                                  <div className="h-6 bg-gray-800 rounded mb-3 border-l-4 border-[#00ED64] pl-3"></div>
                                  <div className="h-3 bg-gray-600 rounded mb-2"></div>
                                  <div className="h-3 bg-gray-600 rounded w-2/3 mb-4"></div>
                                  <div className="flex gap-3 mb-4 p-3 border border-gray-200 rounded">
                                    <div className="w-12 h-12 bg-[#00ED64] rounded"></div>
                                    <div className="flex-1">
                                      <div className="h-3 bg-gray-700 rounded mb-1"></div>
                                      <div className="h-2 bg-gray-500 rounded w-3/4"></div>
                                    </div>
                                  </div>
                                  <div className="h-9 bg-[#00ED64] rounded border-2 border-[#00ED64]"></div>
                                </>
                              )}
                            </div>
                          </div>
                          <div className="absolute top-2 right-2">
                            <Badge className="bg-[#00ED64]/20 text-[#00ED64] border-[#00ED64]/30">
                    ...
                    {/* Conversion Details */}
                    <div className="mt-6 p-4 bg-[#00ED64]/10 border border-[#00ED64]/30 rounded-lg">
                      <h5 className="text-[#00ED64] font-semibold mb-2">What will change:</h5>
